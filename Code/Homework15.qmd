...
Mutate
you can add the created variable to the original data frame by overwriting it
...
arrange()
arranges rows in increasing order by a certain column variable
```{r}
arrange(compensation, Fruit) 
```

Section 3.6 Top Tips
How to use more than one dplyr verbs in one line of code
...
Section 3.7 GSWR Calculating summary statistics about groups of yoru data
